...
class WorkoutLog extends amplify_core.Model {
  ...
  WorkoutLogModelIdentifier get modelIdentifier {
      return WorkoutLogModelIdentifier(
        id: id
      );
  }
  ...
  const WorkoutLog._internal({required this.id, required routineExerciseId, required date, notes, createdAt, updatedAt}): _routineExerciseId = routineExerciseId, _date = date, _notes = notes, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory WorkoutLog({String? id, required String routineExerciseId, required amplify_core.TemporalDateTime date, String? notes}) {
  ...
  WorkoutLog copyWith({String? routineExerciseId, amplify_core.TemporalDateTime? date, String? notes}) {
    return WorkoutLog._internal(
      id: id,
  ...
  WorkoutLog copyWithModelFieldValues({
    ...
    return WorkoutLog._internal(
      id: id,
      routineExerciseId: routineExerciseId == null ? this.routineExerciseId : routineExerciseId.value,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'routineExerciseId': _routineExerciseId, 'date': _date?.format(), 'notes': _notes, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<WorkoutLogModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<WorkoutLogModelIdentifier>();
  static final ID = amplify_core.QueryField(fieldName: "id");
  static final ROUTINEEXERCISEID = amplify_core.QueryField(fieldName: "routineExerciseId");
 ...
 */
class WorkoutLogModelIdentifier implements amplify_core.ModelIdentifier<WorkoutLog> {
  final String id;

  /** Create an instance of WorkoutLogModelIdentifier using [id] the primary key. */
  const WorkoutLogModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is WorkoutLogModelIdentifier &&
      id == other.id;
  }
