...
import 'package:bodybuilding_app/feature/circuit/screens/add_circuit_exercise_screen.dart';
import 'package:bodybuilding_app/feature/circuit/screens/edit_circuit_exercise_screen.dart';
import 'package:bodybuilding_app/feature/circuit/screens/circuit_play_screen.dart';
import 'package:bodybuilding_app/feature/circuit/screens/edit_circuit_screen.dart';
...
class _CircuitExerciseList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot<CircuitExercise>>(
      stream: linkService.observeForCircuit(circuitId),
