...
import 'package:bodybuilding_app/feature/workout/widgets/timer_add_timed_set_sheet.dart';
import 'package:bodybuilding_app/feature/workout/widgets/timer_session_log_table.dart';
import 'package:bodybuilding_app/feature/workout/widgets/workout_detail_timer_history_table.dart';
...
class _TimerExerciseDashboardState extends State<TimerExerciseDashboard> {
  ...
  Future<void> _loadHistory(String routineExerciseId) async {
    try {
      ...
      safePrint('Timer history load failed: $e $st');
    }
  }
  ...
  Future<void> _loadPersistedSession(String routineExerciseId) async {
    try {
      ...
      safePrint('Timer session load failed: $e $st');
  ...
  Future<void> _onPrimaryAction() async {
    ...
    try {
      ...
      safePrint('Timer persist failed: $e $st');
  ...
  void _finishWorkout({String? logId}) {
    ...
    _sessionSetsService
        ...
        .catchError((Object e, StackTrace st) {
          safePrint('Timer total save failed: $e $st');
          refreshHistory();
        });
  }
