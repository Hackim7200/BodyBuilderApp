...
/// Shows [Exercise.techniques] from DataStore when non-empty.
class TechniqueNotesCard extends StatefulWidget {
  final String amplifyExerciseId;

  const TechniqueNotesCard({
    super.key,
    required this.amplifyExerciseId,
  });
...
class _TechniqueNotesCardState extends State<TechniqueNotesCard> {
  ...
  void initState() {
    super.initState();
    _notesFuture = ExerciseTechniquesService()
        .storedTechniquesTrimmed(widget.amplifyExerciseId);
  }
